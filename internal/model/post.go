...
// PublishRequest represents the request body for publishing/unpublishing a post
...
// TagBrief represents a tag in post responses
...
// SearchPostsRequest represents search query parameters
