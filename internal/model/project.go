...
type ReorderProjectsRequest struct {
	Orders []ProjectOrder `json:"orders" binding:"required,dive"`
}

// ProjectOrder represents a single project order item
...
// ProjectListResponse represents the response for a project in list view (minimal)
